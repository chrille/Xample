...
import org.christer.example.domain.PersonDataOnDemand;
...
privileged aspect PersonIntegrationTest_Roo_IntegrationTest {
    ...
    public void PersonIntegrationTest.testCountPeople() {    
        ...
        long count = org.christer.example.domain.Person.countPeople();        
    ...
    public void PersonIntegrationTest.testFindPerson() {    
        ...
        org.christer.example.domain.Person obj = org.christer.example.domain.Person.findPerson(id);        
    ...
    public void PersonIntegrationTest.testFindAllPeople() {    
        ...
        java.util.List<org.christer.example.domain.Person> result = org.christer.example.domain.Person.findAllPeople();        
    ...
    public void PersonIntegrationTest.testFindPersonEntries() {    
        ...
        java.util.List<org.christer.example.domain.Person> result = org.christer.example.domain.Person.findPersonEntries(0, (int)count);        
    ...
    public void PersonIntegrationTest.testPersist() {    
        org.junit.Assert.assertNotNull("Data on demand for 'Person' failed to initialize correctly", dod.getRandomPerson());        
        org.christer.example.domain.Person obj = dod.getNewTransientPerson(Integer.MAX_VALUE);        
    ...
    public void PersonIntegrationTest.testRemove() {    
        ...
        org.junit.Assert.assertNotNull("Find method for 'Person' illegally returned null for id '" + id + "'", obj);        
        obj.remove();        
        org.junit.Assert.assertNull("Failed to remove 'Person' with identifier '" + id + "'", org.christer.example.domain.Person.findPerson(id));        
    }    
